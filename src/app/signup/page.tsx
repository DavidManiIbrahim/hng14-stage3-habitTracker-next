    ...
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden bg-gray-900">
      ...
      <div className="w-full max-w-md relative z-10 px-4 py-8">
        <div className="text-center mb-8">
          ...
          <h1 className="text-4xl font-extrabold text-white tracking-tight">Join Us</h1>
          <p className="text-gray-300 mt-2 font-medium">Start your journey to better habits today.</p>
        </div>
